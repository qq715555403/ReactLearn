...
export default class AlignItemsBasics extends Component {
    ...
    newMethod() {
        ...
        */
        ...
        三、super 关键字
        //********************************************************************************************************* 
        它既可以当作函数使用，也可以当作对象使用。在这两种情况下，它的用法完全不同。

        1、第一种情况，super作为函数调用时，代表父类的构造函数。ES6 要求，子类的构造函数必须执行一次super函数。
                class A {}
                class B extends A {
                    constructor() {
                        super();//代表调用父类的构造函数。这是必须的，否则 JavaScript 引擎会报错
                    }
                }
                注意:
                ...
                class B extends A {
                    constructor() {
                        //可以看到，在super()执行时，new.target指向的是子类B的构造函数，而不是父类A的构造函数。
        ...
        2、第二种情况，super作为对象时，在普通方法中，指向父类的原型对象；在静态方法中，指向父类。
            ...
            注意，使用super的时候，必须显式指定是作为函数、还是作为对象使用，否则会报错。
                ...
                上面例子中：console.log(super)当中的super，无法看出是作为函数使用，还是作为对象使用，
        ...
        3、最后，由于对象总是继承其他对象的，所以可以在任意一个对象中，使用super关键字。
                var obj = {
                    toString() {
        ...
        */
        ...
        （1）子类的__proto__属性，表示【构造函数】的继承，总是指向父类。
        （2）子类prototype属性的__proto__属性，表示【方法】的继承，总是指向父类的prototype属性。
                class A {
                }
        ...
        */
        ...
        上面例子也说明，extends关键字不仅可以用来继承类，还可以用来继承原生的构造函数。
