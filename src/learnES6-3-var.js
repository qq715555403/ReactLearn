...
export default class AlignItemsBasics extends Component {
    ...
    newMethod() {
        /*
        变量的解构赋值:
        ES6 允许按照一定模式，从数组和对象中提取值，对变量进行赋值，这被称为解构。如果解构不成功，变量的值就等于undefined。
            数组的解构赋值
            对象的解构赋值
            字符串的解构赋值
            数值和布尔值的解构赋值
        ...
        */
        ...
        // let [x = 1] = [null];//x = null;一个数组成员是null，默认值就不会生效，因为null不严格等于undefined。
        ...
        */
        ...
        // let {foo} = {bar: 'baz'};//因为解构失败：所以：foo // undefined
        ...
        // 代码9：==========================================================
        // 解构赋值允许等号左边的模式之中，不放置任何变量名：表达式虽然毫无意义，但是语法是合法的，可以执行。
        // ({} = [true, false]);
        // ({} = 'abc');
        // ({} = []);
        ...
        */
        ...
        // let {toString: s} = 123;
        // console.log(s)//这打印的是什么鬼？？？function toString() { … }
        // if(s === Number.prototype.toString ){// true
        //     console.log('数值解构赋值')
        // }
        
        // let {toString: s} = true;
        // if(s === Boolean.prototype.toString ){// true
        //     console.log('布尔值解构赋值')
        // }
